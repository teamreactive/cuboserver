...
class Solicitud(models.Model):
	...
	centro = models.ForeignKey(CentroDeCosto, related_name="Solicitud.centro", null=True)
	equipo = models.ForeignKey(Equipo, related_name="Solicitud.equipo", null=True)
	proyecto = models.CharField(max_length=25)
	productos = models.ManyToManyField(UnidadProducto, through="ProductoSolicitud")
...
class ProductoSolicitud(models.Model):
	...
	solicitud = models.ForeignKey(Solicitud, related_name="ProductoSolicitud.solicitu")
