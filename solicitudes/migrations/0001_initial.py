    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(max_length=1, choices=[(b'1', b'solicitudud de compra creada'), (b'2', b'solicitudud de compra rechazada'), (b'3', b'solicitudud de compra aprobada'), (b'4', b'cotizacion creada')])),
