...
def inicio_solicitante(request):
    #usuario = get_usuario(request) # THIS IS TEMPORAL
    #if usuario and usuario.tipo == '3': # THIS IS TEMPORAL
    usuario = Usuario.objects.get(nombre='jcbages') # THIS IS TEMPORAL
    ...
    #    return redirect('/') # THIS IS TEMPORAL